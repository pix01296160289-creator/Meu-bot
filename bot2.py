...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    legenda_boas_vindas = (
        "🚀 **SNAP SINAIS BOT — TERMINAL PROFISSIONAL** 📈\n\n"
        "Ambiente de alta performance para análise de ativos e tendências.\n\n"
        "Para iniciarmos sua credencial de acesso, por favor:\n"
...
async def enviar_menu_principal(update_or_query, context, nome_usuario):
    teclado = [
        ...
        [InlineKeyboardButton("💱 Câmbio & Moedas (BRL)", callback_data="menu_forex")],
    ...
    texto_menu = (
        ...
        f"🟢 **STATUS:** Conectado à API\n"
        f"━━━━━━━━━━━━━━━━━━━\n\n"
        f"Selecione o mercado desejado abaixo para iniciar a varredura:"
    )
...
async def mostrar_menu_binarias(query, nome_usuario):
    ...
    texto = (
        f"📊 **MERCADO DE OPÇÕES BINÁRIAS (M5)**\n"
        f"━━━━━━━━━━━━━━━━━━━\n"
        f"Selecione o par de moedas para monitoramento em tempo real:"
    )
...
async def mostrar_menu_forex(query, nome_usuario):
    ...
    texto = (
        f"💱 **MERCADO DE CÂMBIO (BRL)**\n"
        f"━━━━━━━━━━━━━━━━━━━\n"
        f"Selecione a paridade cruzada com o Real:"
    )
    await query.edit_message_text(texto, reply_markup=reply_markup, parse_mode="Markdown")
...
async def mostrar_menu_cripto(query, nome_usuario):
    ...
    texto = (
        f"🪙 **CRIPTOMOEDAS E METAIS**\n"
        f"━━━━━━━━━━━━━━━━━━━\n"
        f"Selecione o ativo digital ou commodity desejado:"
    )
    await query.edit_message_text(texto, reply_markup=reply_markup, parse_mode="Markdown")
